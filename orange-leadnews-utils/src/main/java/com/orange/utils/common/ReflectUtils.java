...
public class ReflectUtils {
    ...
    public static Annotation[] getFieldAnnotations(Object bean, PropertyDescriptor propertyDescriptor) {
        List<Field> fieldList = Arrays.asList(bean.getClass().getDeclaredFields()).stream()
                .filter(f -> f.getName().equals(propertyDescriptor.getName())).collect(Collectors.toList());
